...
export class FAQMainPageComponent {
  ...
  constructor(private titleService:Title,private meta: Meta, private router: Router, private jsonLdService: JsonLdService){
  ...
  ngOnInit(): void {
    ...
    if(this.router.url=='/movers/faq'){
      ...
      this.meta.updateTag({ name: 'description', content:     'Explore commonly asked questions about movers to gain specialist insights into moving services. Explore FAQs on local and long-distance moves.'    });
      ...
      this.titleService.setTitle(this.FAQ.title);
      this.meta.updateTag({ name: 'description', content: 'Get specialist insights into residential moving services. Explore FAQs on local and long-distance moves, packing, pricing, and insurance coverage.' });
    }
